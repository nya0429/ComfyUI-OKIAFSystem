...
class GetStudyParameter:
    ...
    RETURN_NAMES = ("positive_prompt", "negative_prompt","filename_prefix",)
    FUNCTION = "run"
    OUTPUT_NODE = True

    CATEGORY = "StudyNodes"

    def run(self, positive_prompt,negative_prompt):
        # folder_paths.get_input_directory()
        print('running')
        res = get("https://osaka-international-art-festival.studiognu.org/api/prompt/mv")
        ...
        return (_positive_prompt, _negative_prompt,"test",)
